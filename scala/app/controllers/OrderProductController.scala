...
/**
  */
@Singleton
class OrderProductController @Inject()(orderProductRepository: OrderProductRepository,cc: ControllerComponents)(implicit ec: ExecutionContext) extends AbstractController(cc) {
